const SESSION_KEY = 'remotecode.sessionId';
...
const ACTIVE_CONVERSATION_KEY = 'remotecode.activeConversationId';
const SELECTED_MODEL_KEY = 'remotecode.selectedModel';
...
const THEME_KEY = 'remotecode.theme';
