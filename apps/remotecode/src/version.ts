...
import { isRecord } from '@remotecode/shared';
 ...
 */
declare const REMOTECODE_BUNDLED_VERSION: string | undefined;

function bundledVersion(): string | undefined {
  // Guarded because the identifier only exists in a bundled build.
  const value =
    typeof REMOTECODE_BUNDLED_VERSION === 'string' ? REMOTECODE_BUNDLED_VERSION : undefined;
